    ...
    public abstract class Loader : MonoBehaviour {
        ...
        protected virtual void OnLoaded (GameObject obj, string absolutePath) {
            if (obj == null) {
                ...
                //////////////////////
                //TODO --> Widget back to toggleAR(false)
                GameManagerScript.Instance.ImportedOBJ = obj;
                obj.SetActive (false);
                foreach (Transform child in obj.transform) {
                    child.gameObject.AddComponent<MeshCollider> ();
                }
                GameManagerScript.Instance.ARManager.ToggleAR (true);
                GameManagerScript.Instance.ARManager.startFirstPhase ();
                //////////////////////
            }
        }
